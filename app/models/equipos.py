...
class Equipo(db.Model):
    ...
    estado              = db.Column(db.Enum('disponible', 'prestado', 'mantenimiento', 'dañado', 'perdido', 'eliminado', 'fuera_de_servicio', 'no_disponible', name='estado_equipo'), default='disponible')
